            ...
            <div class="page-footer">
                <div class="page-footer-inner"> 2016 &copy; w3zones By                    
                </div>
    ...
    (function(){
        jQuery(document).ready(function(){
            jQuery("#service").change(function(){
                var restaurantId    = jQuery("#restaurant").val();
                var serviceId       = jQuery("#service").val();
                $.ajax(
                {
                    'url'   : '<?php echo base_url();?>Developer/serviceCheck',
                    'type'  : 'POST',
                    'dataType' : 'json',
                    'data'  :  {
                    ...
                    {      
                        if(output)
                        {
                            ...
                            if(len > 0)
                            {
                                for(var i=0;i<len;i++)
                                {
                                   if(output[i].servicename && output[i].created_date)
                                   {
                                    txt += "<tr><td>"+output[i].servicename+"</td><td>"+output[i].created_date+"</td></tr>";
                                   }
                                }                                  
