    ...
    <div class="page-sidebar-wrapper">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                ...
                <!-- START OF MENU SETTINGS SECTION -->                
                <li class="nav-item">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="nav-item  ">
                            <a href="layout_full_height_portlet.html" class="nav-link ">
                                <span class="title">Menu Log</span>
                            </a>
                        </li>
                    </ul>
                </li>
                <!-- END OF MENU SETTINGS SECTION -->

                <!-- START OF DEVELOPER SECTION -->
                <li class="nav-item">
                    <a href="javascript:;" class="nav-link nav-toggle">
                        <i class=" icon-wrench"></i>
                        <span class="title">Developer Section</span>
                        <span class="arrow"></span>
                    </a>
                    <ul class="sub-menu">
                        <li class="nav-item  ">
                        ...
                        <li class="nav-item  ">
                            <a href="layout_full_height_portlet.html" class="nav-link ">
                                <span class="title">Form Log</span>
                            </a>
                        </li>
                    </ul>
                </li>
